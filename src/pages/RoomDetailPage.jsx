...
import { 
    ...
    FaShieldAlt, FaHome, FaExclamationTriangle, FaCheckCircle,
...
const RoomDetailPage = () => {
    ...
    useEffect(() => {
        const fetchDetail = async () => {
            try {
                // ĐÃ FIX: URL gọi đúng api posts detail
                const res = await axios.get(`http://localhost:5000/api/posts/detail/${id}`);
                // ĐÃ FIX: Kiểm tra res.data.data thay vì success
    ...
    // Xử lý ảnh: Đảm bảo không bị crash nếu không có ảnh
    ...
    // Lấy 3 ảnh đầu để hiển thị Grid (1 to, 2 nhỏ)
        ...
        <div className="rd-wrapper">
            ...
            <div className="rd-container">
                ...
                <div className="rd-gallery-container">
                    {/* Tự động đổi class grid-1, grid-2, grid-3 */}
                    ...
                    <div className="rd-left">
                        ...
                        <div className="rd-section">
                            ...
                            <div className="rd-map-placeholder">
                                ...
                                <span>Bản đồ khu vực đang được cập nhật</span>
                        ...
                        <div className="rd-sidebar-inner">
                            <div className="rd-host-card">
                                <div className="rd-host-info">
                                    ...
                                    />
                                    <div>
                                        <div className="rd-host-name">{post.user?.user_full_name || 'Chủ trọ'}</div>
                                ...
                                >
                                    <FaPhoneAlt/> {post.user?.phone_number || 'Hiện số điện thoại'}
                                </button>

                                <button className="rd-btn-action btn-zalo">
                                    <FaCommentDots size={18}/> Chat qua Zalo
                                </button>
                            </div>
